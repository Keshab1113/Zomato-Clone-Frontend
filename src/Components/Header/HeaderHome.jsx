...
const HeaderHome = () => {
  ...
  return (
    <header className=" absolute h-16 w-full top-0 flex justify-center z-40">
      <div className="  h-full w-4/5 flex flex-row">
        <div className=" w-2/4 h-full  flex items-center">
          ...
          <button className=" pl-1 text-white">Get the App</button>
        </div>
        <div className=" w-2/4 h-full flex justify-between items-center">
          <button className=" text-xl font-normal text-white">
            Investor Relations
          </button>
          <button className=" text-xl font-normal text-white">
            Add Restaurant
          ...
          >
            Log in
                  ...
                  <button className=" text-xl font-normal text-white">Sign up</button>
                  <Modal show={openModal} size="md" onClose={onCloseModal} popup>
                      <Modal.Header />
                      <Modal.Body>
                          <div className="space-y-6">
                              <h3 className="text-3xl font-medium text-gray-900 dark:text-white">Login</h3>
                              <div>
                              ...
                              <div className="w-full">
                                  <Button className="bg-[rgb(239,79,95)] w-full hover:bg-[rgb(240,71,88)]">Send One Time Password</Button>
                                  <div className="divider divider-primary">OR</div>
                                  <Button className="w-full">Send One Time Password</Button>
                                  <Button className="w-full">Send One Time Password</Button>
                                  <div className="divider divider-primary">OR</div>
                              </div>
